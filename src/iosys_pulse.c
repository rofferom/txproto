...
static const AVChannelLayout pa_to_lavu_ch_map(const pa_channel_map *ch_map)
{
    static const uint64_t channel_map[PA_CHANNEL_POSITION_MAX] = {
        ...
        [PA_CHANNEL_POSITION_FRONT_CENTER]          = AV_CHAN_FRONT_CENTER,
        [PA_CHANNEL_POSITION_REAR_CENTER]           = AV_CHAN_BACK_CENTER,
        [PA_CHANNEL_POSITION_REAR_LEFT]             = AV_CHAN_BACK_LEFT,
        [PA_CHANNEL_POSITION_REAR_RIGHT]            = AV_CHAN_BACK_RIGHT,
        [PA_CHANNEL_POSITION_LFE]                   = AV_CHAN_LOW_FREQUENCY,
        [PA_CHANNEL_POSITION_FRONT_LEFT_OF_CENTER]  = AV_CHAN_FRONT_LEFT_OF_CENTER,
        [PA_CHANNEL_POSITION_FRONT_RIGHT_OF_CENTER] = AV_CHAN_FRONT_RIGHT_OF_CENTER,
        [PA_CHANNEL_POSITION_SIDE_LEFT]             = AV_CHAN_SIDE_LEFT,
        [PA_CHANNEL_POSITION_SIDE_RIGHT]            = AV_CHAN_SIDE_RIGHT,
        [PA_CHANNEL_POSITION_TOP_CENTER]            = AV_CHAN_TOP_CENTER,
        [PA_CHANNEL_POSITION_TOP_FRONT_LEFT]        = AV_CHAN_TOP_FRONT_LEFT,
        [PA_CHANNEL_POSITION_TOP_FRONT_RIGHT]       = AV_CHAN_TOP_FRONT_RIGHT,
        [PA_CHANNEL_POSITION_TOP_FRONT_CENTER]      = AV_CHAN_TOP_FRONT_CENTER,
        [PA_CHANNEL_POSITION_TOP_REAR_LEFT]         = AV_CHAN_TOP_BACK_LEFT,
        [PA_CHANNEL_POSITION_TOP_REAR_RIGHT]        = AV_CHAN_TOP_BACK_RIGHT,
...
static int pulse_ioctx_ctrl_cb(AVBufferRef *event_ref, void *callback_ctx, void *ctx,
                               void *dep_ctx, void *data)
{
    SPCtrlTemplateCbCtx *event = callback_ctx;

    IOSysEntry *iosys_entry = ctx;
    PulsePriv *priv = iosys_entry->api_priv;
...
static int pulse_ctrl(AVBufferRef *ctx_ref, SPEventType ctrl, void *arg)
{
    int err = 0;
    PulseCtx *ctx = (PulseCtx *)ctx_ref->data;
