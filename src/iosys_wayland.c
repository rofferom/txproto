...
#define FMTDBL(fmt) DRM_FORMAT_##fmt, WL_SHM_FORMAT_##fmt
        ...
        { FMTDBL(XRGB2101010), FMTDBL(XRGB2101010), AV_PIX_FMT_X2RGB10 },
        { FMTDBL(XBGR2101010), FMTDBL(XBGR2101010), AV_PIX_FMT_X2BGR10 },
        { FMTDBL(ARGB2101010), FMTDBL(XRGB2101010), AV_PIX_FMT_X2RGB10 },
        { FMTDBL(ABGR2101010), FMTDBL(XBGR2101010), AV_PIX_FMT_X2BGR10 },
                                   ...
                                   void *dep_ctx, void *data)
{
    ...
    if (event->ctrl & SP_EVENT_CTRL_START) {
        ...
        pthread_mutex_unlock(&priv->frame_obj_lock);
        sp_event_send_eos_frame(entry, entry->events, entry->frames, AVERROR(EOF));
        return 0;
    } else {
