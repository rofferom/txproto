...
AVBufferRef *epoch_event_new(TXMainContext *ctx);

int epoch_event_set_source(AVBufferRef *epoch_event,
                           AVBufferRef *obj);

int epoch_event_set_offset(AVBufferRef *epoch_event,
                           int64_t value);

int epoch_event_set_system(AVBufferRef *epoch_event);

int epoch_event_set_external(AVBufferRef *epoch_event,
                             int (*external_cb)(int64_t systemtime, AVBufferRef *arg),
                             AVBufferRef *external_arg);
